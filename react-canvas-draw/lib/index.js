...
var _default = (_temp = _class = function (_PureComponent) {
  ...
  function _default(props) {
    ...
    _this.handlePointerMove = function (x, y) {
      ...
      var hasChanged = _this.lazy.update({ x: x, y: y });
			...
			const point = _this.props.erase ? { ..._this.lazy.brush.toObject(), erase: true } : _this.lazy.brush.toObject();
      ...
      if (_this.isDrawing && (_this.lazy.brushHasMoved() || isDisabled)) {
        ...
        _this.drawPoints({
          points: _this.points,
          brushColor: point.erase ? "erase" : _this.props.brushColor,
    ...
    _this.drawPoints = function (_ref3) {
      ...
      _this.ctx.temp.strokeStyle = brushColor === "erase" ? _this.props.backgroundColor : brushColor;
			_this.ctx.drawing.globalCompositeOperation = brushColor === "erase" ? "destination-out" : "source-over";
    ...
    _this.drawInterface = function (ctx, pointer, brush) {
      ...
      // Draw brush preview
      ctx.beginPath();
      ctx.fillStyle = _this.props.erase ? _this.props.backgroundColor : _this.props.brushColor;
  ...
  erase: _propTypes2.default.bool
}, _class.defaultProps = {
  onChange: null,
  loadTimeOffset: 5,
  lazyRadius: 12,
